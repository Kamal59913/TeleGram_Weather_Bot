...
export const Search = <T,>({
  ...
  const [hasMoreRecommendations, setHasMoreRecommendations] =
        ...
        <div className="relative group">
          ...
          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
            ...
            <button
              ...
              className="bg-[#4a90d9] hover:bg-gray-600 dark:bg-white dark:from-white dark:to-gray-100 dark:hover:from-gray-100 dark:hover:to-white disabled:cursor-not-allowed disabled:transform-none duration-200 flex focus:outline-none focus:ring-2 focus:ring-[#9B3B97]/50 font-semibold gap-2 items-center px-5 py-2.5 rounded-lg text-sm text-white dark:text-black"
            >
              {isLoading ? (
                <>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                  Parent data retrieved for phone:{" "}
