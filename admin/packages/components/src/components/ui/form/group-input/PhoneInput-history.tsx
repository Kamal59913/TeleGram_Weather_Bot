  ...
  return (
    <div className="relative flex">
      ...
      <input
        ...
        } rounded-lg border border-gray-300 bg-transparent py-3 px-4 text-sm text-black shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-black dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800`}
      />
